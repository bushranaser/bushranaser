!function(e) {
    ...
    !function() {
        function e(e) {
            var n = "";
            if (n = window.location.origin ? window.location.origin : window.location.protocol + "://" + window.location.host,
            e && "string" == typeof e)
                if (0 === e.indexOf("/"))
                    n += e;
                else
        ...
        !function() {
            ...
            function l(e) {
                if ("function" == typeof g.getEntriesByType) {
                    var n = g.getEntriesByType("navigation")
                      , t = {};
                    e.timingsV2 = {},
                    n && n[0] && (n[0].serverTiming && (t.serverTiming = n[0].serverTiming),
            ...
            function p() {
                ...
                return T && (T.version && (r.versions.fl = T.version),
                T.icTag && (r.icTag = T.icTag),
                r.siteToken = T.token),
                A && ["lcp", "fid", "cls", "fcp", "ttfb", "inp"].forEach(function(e) {
                    r[e] = {
                        value: -1,
                        path: void 0
                    },
            ...
            function v(r) {
                ...
                if (void 0 == P) {
                    if ("function" == typeof g.getEntriesByType) {
                        ...
                        y && Array.isArray(y) && y.length > 0 && (v.timingsV2 = {},
                        v.versions.timings = 2,
                        delete v.timings,
                        u(y[0], v.timingsV2))
                    }
                    1 === v.versions.timings && u(a, v.timings),
                    u(c, v.memory)
                } else
                    l(v);
                if (v.documentWriteIntervention = n(),
                v.firstPaint = m("first-paint"),
                v.firstContentfulPaint = m("first-contentful-paint"),
                v.errorCount = window.__cfErrCount || 0,
                T && (T.icTag && (v.icTag = T.icTag),
                v.siteToken = T.token),
                "function" == typeof g.getEntriesByType) {
                    ...
                    w.forEach(function(e) {
                        ...
                        E + r < 62e3 && v.tempResources ? (E += r,
                        v.tempResources[S].push(n)) : (S++,
                        E = 0)
                    })
                }
                return JSON.stringify(v).length >= 64e3 && (v.resources = []),
                void 0 !== P && (delete v.timings,
                delete v.memory,
                delete v.errorCount,
                ...
                if (g && T && T.token) {
                    ...
                    document.addEventListener("visibilitychange", function() {
                        if ("hidden" === document.visibilityState) {
                            if (x && q()) {
                                var n = e();
                                (null === B || void 0 === B ? void 0 : B.url) == n && null !== B && void 0 !== B && B.triggered || M(),
                                H(n)
                            }
                            !O && B && (O = !0,
                            V())
                        } else
                            "visible" === document.visibilityState && (_ = (new Date).getTime())
                    });
                    var A = {}
                      , I = function(e) {
                        if (!e || 0 === e.length)
                      ...
                      , N = function(e) {
                        if (!e)
                            return "";
                        var n = e.localName;
                        return e.id && e.id.length > 0 && (n += "#" + e.id),
                      ...
                      , k = function(e) {
                        ...
                        e.name) {
                        case "CLS":
                            (t = I(e.entries)) && A.cls && (A.cls.element = N(t.node),
                            A.cls.currentRect = t.currentRect,
                            A.cls.previousRect = t.previousRect);
                            break;
                        case "FID":
                            t && A.fid && (A.fid.element = N(t.target),
                            A.fid.name = t.name);
                            break;
                        case "LCP":
                            t && A.lcp && (A.lcp.element = N(t.element),
                            A.lcp.size = t.size,
                            A.lcp.url = t.url)
                        }
                    };
                    ...
                    var x = T && (void 0 === T.spa || !0 === T.spa)
                      ...
                      , M = function(e) {
                        var n = function(e, n) {
                            ...
                            T && (1 === T.r && (t.resources = []),
                            (0,
                            o.sendObjectBeacon)("", t, function() {}, !1, j),
                            void 0 !== T.forward && void 0 !== T.forward.url && (0,
                            o.sendObjectBeacon)("", t, function() {}, !1, T.forward.url))
                        }
                          , t = v(e);
                        if (t && T) {
                      ...
                      , V = function() {
                        var e = p();
                        x || (e.resources = [],
                        delete e.tempResources),
                        T && (0,
                        o.sendObjectBeacon)("", e, function() {}, !0, j)
                    }
                      , D = function() {
                    ...
                    function(n) {
                        ...
                        if (t) {
                            var r = function() {
                                h = c(),
                                "function" == typeof g.clearResourceTimings && g.clearResourceTimings(),
                                _ = 0
                            };
                            n.pushState = function(i, o, a) {
                                ...
                                var c = e()
                                  , u = !0;
                                return P == c && (u = !1),
                                u && (q() && ((null === B || void 0 === B ? void 0 : B.url) == c && null !== B && void 0 !== B && B.triggered || M(c),
                                H(c)),
                                r()),
                                t.apply(n, [i, o, a])
                            }
                            ...
                            window.addEventListener("popstate", function(n) {
                                q() && ((null === B || void 0 === B ? void 0 : B.url) == P && null !== B && void 0 !== B && B.triggered || M(P),
                                H(P)),
                                P = e(),
                                r()
                            })
...
, function(e, n, t) {
    "use strict";
    n.__esModule = !0,
    n.onTTFB = n.onLCP = n.onINP = n.onFID = n.onFCP = n.onCLS = n.getTTFB = n.getLCP = n.getINP = n.getFID = n.getFCP = n.getCLS = void 0;
    var r, i, o, a, c, u = -1, s = function(e) {
        ...
        var t, r = [1800, 3e3], i = w(), o = l("FCP"), a = function(e) {
            e.forEach(function(e) {
                ...
                e.startTime < i.firstHiddenTime && (o.value = e.startTime - d(),
                o.entries.push(e),
                t(!0)))
            })
        }, c = window.performance && window.performance.getEntriesByName && window.performance.getEntriesByName("first-contentful-paint")[0], u = c ? null : p("paint", a);
        (c || u) && (t = m(e, o, r, n.reportAllChanges),
        c && a([c]),
        s(function(i) {
            o = l("FCP"),
        ...
        var r, i = function(n) {
            ...
            e.forEach(function(e) {
                if (!e.hadRecentInput) {
                    var n = c[0]
                      , t = c[c.length - 1];
                    a && e.startTime - t.startTime < 1e3 && e.startTime - n.startTime < 5e3 ? (a += e.value,
                    c.push(e)) : (a = e.value,
                    c = [e]),
                    a > o.value && (o.value = a,
                    o.entries = c,
        ...
        f && (r = m(i, o, t, n.reportAllChanges),
        v(function() {
            u(f.takeRecords()),
            r(!0)
        }),
        ...
        var r, i = l("INP"), o = function(e) {
            e.forEach(function(e) {
                e.interactionId && q(e),
                "first-input" === e.entryType && !V.some(function(n) {
                    return n.entries.some(function(n) {
                        return e.duration === n.duration && e.startTime === n.startTime
                    })
                }) && q(e)
            });
            var n, t = (n = Math.min(V.length - 1, Math.floor(M() / 50)),
            V[n]);
        ...
        U(function() {
            var o = f();
            if (o) {
                if (r.value = Math.max(o.responseStart - d(), 0),
                ...
                s(function() {
                    r = l("TTFB", 0),
                    (i = m(e, r, t, n.reportAllChanges))(!0)
                })
            }
        })
    };
